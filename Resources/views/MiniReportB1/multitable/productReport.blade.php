...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        const reportName = "productReport";
            ...
            product_table = $('#product_table').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        data: 'image',
                        name: 'products.image',
                        visible: isViewMode ? visibleColumnNames.includes("Product image") ||
                            visibleColumnNames.includes("រូបភាពផលិតផល") : true
                    },
                    {
                        data: 'action',
                        name: 'action',
                        visible: isViewMode ? visibleColumnNames.includes("Detail") ||
                            visibleColumnNames.includes("លំអិត") : true
                    },
                    {
                        data: 'product',
                        name: 'products.name',
                        visible: isViewMode ? visibleColumnNames.includes("Product") ||
                            visibleColumnNames.includes("ផលិតផល") : true
                    },
                    {
                        data: 'product_locations',
                        name: 'product_locations',
                        visible: isViewMode ? visibleColumnNames.includes("Location") ||
                            visibleColumnNames.includes("ទីតាំងសាខា") : true
                    },
                    @can('view_purchase_price')
                        {
                            ...
                            visible: isViewMode ? visibleColumnNames.includes("Unit Purchase Price") ||
                                visibleColumnNames.includes("ថ្លៃឯកតាទិញចូល") : true
                        },
                    @endcan
                    @can('access_default_selling_price')
                        {
                            ...
                            name: 'max_price',
                            searchable: false,
                            visible: isViewMode ? visibleColumnNames.includes("Selling Price") ||
                                visibleColumnNames.includes("ថ្លៃលក់ចេញ") : true
                        },
                    @endcan {
                        data: 'current_stock',
                        searchable: false,
                        visible: isViewMode ? visibleColumnNames.includes("Current stock") ||
                            visibleColumnNames.includes("ស្តុកបច្ចុប្បន្ន") : true
                    },
                    {
                        data: 'type',
                        name: 'products.type',
                        visible: isViewMode ? visibleColumnNames.includes("Product Type") ||
                            visibleColumnNames.includes("ប្រភេទផលិតផល") : true
                    },
                    {
                        data: 'category',
                        name: 'c1.name',
                        visible: isViewMode ? visibleColumnNames.includes("Category") ||
                            visibleColumnNames.includes("ក្រុម") : true
                    },
                    {
                        data: 'brand',
                        name: 'brands.name',
                        visible: isViewMode ? visibleColumnNames.includes("Brand") || visibleColumnNames
                            .includes("ម៉ាក") : true
                    },
                    {
                        data: 'tax',
                        name: 'tax_rates.name',
                        searchable: false,
                        visible: isViewMode ? visibleColumnNames.includes("Tax") || visibleColumnNames
                            .includes("ពន្ធ") : true
                    },
                    {
                        data: 'sku',
                        name: 'products.sku',
                        visible: isViewMode ? visibleColumnNames.includes("SKU") || visibleColumnNames
                            .includes("SKU") : true
                    },
                    {
