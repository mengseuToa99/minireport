...
@section('javascript')
    ...
    columns: [{
        ...
        },
        {
            ...
            visible: isViewMode ? visibleColumnNames.includes("Date") || visibleColumnNames.includes("ថ្ងៃខែឆ្នាំម៉ោង") : true
        },
        {
            data: 'invoice_no',
            name: 'invoice_no',
            visible: isViewMode ? visibleColumnNames.includes("Invoice No.") || visibleColumnNames.includes("លេខ") : true
        },
        {
            data: 'conatct_name',
            name: 'conatct_name',
            visible: isViewMode ? visibleColumnNames.includes("Customer name") || visibleColumnNames.includes("ឈ្មោះ") : true
        },
        {
            data: 'mobile',
            name: 'contacts.mobile',
            visible: isViewMode ? visibleColumnNames.includes("Contact Number") || visibleColumnNames.includes("ទូរស័ព្ទ") : true
        },
        {
        ...
        },
        {
            ...
            orderable: false,
            searchable: false,
            visible: isViewMode ? visibleColumnNames.includes("Payment Method") || visibleColumnNames.includes("មធ្យោបាយបង់ប្រាក់") : true
        },
        {
            data: 'final_total',
            name: 'final_total',
            visible: isViewMode ? visibleColumnNames.includes("Total Amount") || visibleColumnNames.includes("សរុប") : true
        },
        {
            data: 'total_paid',
            name: 'total_paid',
            searchable: false,
            visible: isViewMode ? visibleColumnNames.includes("Total Paid") || visibleColumnNames.includes("សរុបបានបង់") : true
        },
        {
            data: 'total_remaining',
            name: 'total_remaining',
            visible: isViewMode ? visibleColumnNames.includes("Total Due") || visibleColumnNames.includes("ជំពាក់") : true
        },
        {
            data: 'return_due',
            orderable: false,
            searchable: false,
            visible: isViewMode ? visibleColumnNames.includes("Return Due") || visibleColumnNames.includes("ទិញវិញជំពាក់") : true
        },
        {
            data: 'shipping_status',
            name: 'shipping_status',
            visible: isViewMode ? visibleColumnNames.includes("Shipping Status") || visibleColumnNames.includes("ស្ថានភាពដឹក") : true
        },
        {
            data: 'total_items',
            name: 'total_items',
            searchable: false,
            visible: isViewMode ? visibleColumnNames.includes("Total Items") || visibleColumnNames.includes("មុខទំនិញ") : true
        },
        {
            data: 'types_of_service_name',
            name: 'tos.name',
            visible: isViewMode ? visibleColumnNames.includes("Types of Service") || visibleColumnNames.includes("ប្រភេទនៃសេវាកម្ម") : true
        },
        {
            data: 'service_custom_field_1',
            name: 'service_custom_field_1',
            visible: isViewMode ? visibleColumnNames.includes("Service Custom Field 1") || visibleColumnNames.includes("តារាងបន្ថែម 1") : true
        },
        {
            data: 'custom_field_1',
            name: 'transactions.custom_field_1',
            visible: isViewMode ? visibleColumnNames.includes("Custom Field 1") || visibleColumnNames.includes("") : true
        },
        {
            data: 'custom_field_2',
            name: 'transactions.custom_field_2',
            visible: isViewMode ? visibleColumnNames.includes("Custom Field 2") || visibleColumnNames.includes("") : true
        },
        {
            data: 'custom_field_3',
            name: 'transactions.custom_field_3',
            visible: isViewMode ? visibleColumnNames.includes("Custom Field 3") || visibleColumnNames.includes("") : true
        },
        {
            data: 'custom_field_4',
            name: 'transactions.custom_field_4',
            visible: isViewMode ? visibleColumnNames.includes("Custom Field 4") || visibleColumnNames.includes("") : true
        },
        {
            data: 'added_by',
            name: 'u.first_name',
        ...
        },
        {
            ...
            visible: isViewMode ? visibleColumnNames.includes("Sell note") || visibleColumnNames.includes("ចំណាំ") : true
        },
        {
            data: 'staff_note',
            name: 'staff_note',
            visible: isViewMode ? visibleColumnNames.includes("Staff note") || visibleColumnNames.includes("កំណត់ត្រាបុគ្គលិក") : true
        },
        {
            data: 'shipping_details',
            name: 'shipping_details',
            visible: isViewMode ? visibleColumnNames.includes("Shipping Details") || visibleColumnNames.includes("លំអិត") : true
        },
        {
            data: 'table_name',
            name: 'tables.name',
            visible: isViewMode ? visibleColumnNames.includes("Table") || visibleColumnNames.includes("តុ") : true
        },
        {
            data: 'waiter',
            name: 'ss.first_name',
            visible: isViewMode ? visibleColumnNames.includes("Service Staff") || visibleColumnNames.includes("បុគ្គលិកប្រចាំការ") : true
        }
    ],
