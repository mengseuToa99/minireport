...
<script>
    ...
    $(document).ready(function() {
        ...
        // Apply filter criteria to the UI for supplierReport
        console.log("Applying supplier filters to UI...");
        ...
        $('#contact_date_range').val(filters.dateRange);
        $('#filed_customer_id').val(filters.customer_id); // Consider renaming to supplier_id if appropriate
