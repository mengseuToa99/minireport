        ...
        <table class="reusable-table" id="productTable">
            <thead>
                <tr>
                    ...
                    <th class="col-md">ប្រភេទផលិតផល</th>
                    <th class="col-sm">លេខកូដ</th>
                    <th class="col-md">តម្លៃលក់</th>
                    <th class="col-md">ដើមគ្រា</th>
                    <th class="col-md">ទិញចូល</th>
                    <th class="col-md">លក់ចេញ</th>
                    <th class="col-md">កែតម្រូវ</th>
                    <th class="col-md">ផ្ទេរចូល</th>
                    <th class="col-md">ផ្ទេរចេញ</th>
                    <th class="col-md">ចុងគ្រា</th>
                </tr>
            </thead>
            <tbody>
