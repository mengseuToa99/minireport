...
@section('content')
    ...
    <!-- Add a dropdown for row selection -->
<!-- Add a dropdown for row selection -->
<div class="row-selection" style="margin: 16px;">
    <label for="row-select">Show:</label>
        ...
        <tbody>
            @forelse($expenses as $expense)
                <tr class="table-row"> <!-- Fixed class attribute -->
                    ...
                    <td class="number"></td>
                    <td class="number"></td>
                    <td class="number">{{ $expense->exchange_rate_khr ?? 4000 }}</td>
                    <td class="number">
                    ...
                    <td class="number">
                        {{ number_format($expense->final_total * 4000, 0) }}
                    </td>
                    <td class="number">
                        @if (isset($expense->exchange_rate_khr))
