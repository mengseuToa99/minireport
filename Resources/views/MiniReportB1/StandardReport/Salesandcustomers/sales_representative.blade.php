            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="sr_sales_tab">
                        @include('minireportb1::MiniReportB1.StandardReport.Salesandcustomers.partials.sales_representative_sales')
                    </div>

                    <div class="tab-pane" id="sr_commission_tab">
                        @include('minireportb1::MiniReportB1.StandardReport.Salesandcustomers.partials.sales_representative_commission')
                    </div>

                    <div class="tab-pane" id="sr_expenses_tab">
                        @include('minireportb1::MiniReportB1.StandardReport.Salesandcustomers.partials.sales_representative_expenses')
                    </div>

                    @if(!empty($pos_settings['cmmsn_calculation_type']) && $pos_settings['cmmsn_calculation_type'] == 'payment_received')
                        <div class="tab-pane" id="sr_payments_with_cmmsn_tab">
                            @include('minireportb1::MiniReportB1.StandardReport.Salesandcustomers.partials.sales_representative_payments_with_cmmsn')
                        </div>
                    @endif
                </div>
