...
@section('content')
            ...
            <div class="filter-container">
                <form id="filterForm">
                    ...
                    <div class="report-filter">
                        <p>Customer Group</p>
                        <div class="filter-group">
                            <select class="filter-select" name="customer_group_filter" id="customer_group_filter">
                                <option value="">All Groups</option>
                                @foreach ($customer_groups as $group)
                                    <option value="{{ $group->id }}"
                                        {{ request()->get('customer_group_filter') == $group->id ? 'selected' : '' }}>
                                        {{ $group->name }}
                                    </option>
                                @endforeach
                            </select>
    ...
    @include('minireportb1::MiniReportB1.components.reportheader', [
        'report_name' => 'Customer Location Report – Unmapped Address',
    ])
