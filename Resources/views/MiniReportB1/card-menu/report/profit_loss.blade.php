    ...
    <section class="content">
        ...
        <div class="row no-print">
            ...
            ><i class="fa fa-print"></i> @lang( 'messages.print' )</button> --}}
                ...
                <button class="tw-dw-btn tw-dw-btn-primary tw-text-white pull-right" aria-label="Print" id="printButton">
        ...
        <div class="row no-print" id="pl_data_div">
            <div class="col-md-12">
                <!-- Custom Tabs -->
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="profit_by_products">
                            @include('minireportb1::MiniReportB1.card-menu.report.partials.profit_by_products')
                        </div>

                        <div class="tab-pane" id="profit_by_categories">
                            @include('minireportb1::MiniReportB1.card-menu.report.partials.profit_by_categories')
                        </div>

                        <div class="tab-pane" id="profit_by_brands">
                            @include('minireportb1::MiniReportB1.card-menu.report.partials.profit_by_brands')
                        </div>

                        <div class="tab-pane" id="profit_by_locations">
                            @include('minireportb1::MiniReportB1.card-menu.report.partials.profit_by_locations')
                        </div>

                        <div class="tab-pane" id="profit_by_invoice">
                            @include('minireportb1::MiniReportB1.card-menu.report.partials.profit_by_invoice')
                        </div>

                        <div class="tab-pane" id="profit_by_date">
                            @include('minireportb1::MiniReportB1.card-menu.report.partials.profit_by_date')
                        </div>

                        <div class="tab-pane" id="profit_by_customer">
                            @include('minireportb1::MiniReportB1.card-menu.report.partials.profit_by_customer')
                        </div>
