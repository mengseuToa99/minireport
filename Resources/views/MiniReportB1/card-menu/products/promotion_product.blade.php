        ...
        <div class="content-section">
            ...
            <div class="no-print">
                @component('components.filters', ['title' => __('report.filters'), 'class' => 'no-print'])
                    <form method="GET" action="{{ route('mini_promotion_product') }}" class="filter-form">
                        <div class="row">
                            <!-- Month Filter -->
                            <div class="col-md-3">
                                            ...
                                            <td class="col-price number price-column-{{ $group_price->id }}">
                                                @if (isset($product['group_prices'][$group_price->id]))
                                                    @if (is_array($product['group_prices'][$group_price->id]))
                                                        <span
                                                            class="discounted-price">{{ $product['group_prices'][$group_price->id]['discounted'] }}</span>
                                                        <span
                                                            class="original-price">({{ $product['group_prices'][$group_price->id]['original'] }})</span>
                                                    @else
                                                        {{ $product['group_prices'][$group_price->id] }}
                                                    @endif
                                                @else
                                                    -
                                                @endif
